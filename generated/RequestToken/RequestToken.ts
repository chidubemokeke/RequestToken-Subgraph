...
export class RequestToken extends ethereum.SmartContract {
  static bind(address: Address): RequestToken {
    return new RequestToken("RequestToken", address);
  }
  ...
  try_earlyInvestorWallet(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "earlyInvestorWallet",
      "earlyInvestorWallet():(address)",
      []
  ...
  transferableStartTime(): BigInt {
    let result = super.call(
      "transferableStartTime",
      "transferableStartTime():(uint256)",
      []
    );
  ...
  try_transferableStartTime(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "transferableStartTime",
      "transferableStartTime():(uint256)",
      []
...
export class EmergencyERC20DrainCall extends ethereum.Call {
